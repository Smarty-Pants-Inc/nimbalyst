...
export const WorktreeOnboardingModal: React.FC<WorktreeOnboardingModalProps> = ({
  ...
  return (
    <div
      className="worktree-onboarding-overlay nim-overlay agent-elements-worktree-onboarding-backdrop fixed inset-0 z-[10000] flex items-center justify-center bg-[color-mix(in_srgb,var(--nim-text)_36%,transparent)] p-4 nim-animate-fade-in"
      onClick={onCancel}
      data-testid="agent-elements-worktree-onboarding-backdrop"
      data-agent-elements-shell="worktree-onboarding-backdrop"
    >
      <div
        className="worktree-onboarding-dialog agent-elements-worktree-onboarding agent-elements-tool-card flex w-[min(92vw,480px)] flex-col overflow-hidden rounded-[var(--an-border-radius)] border border-[var(--an-border-color)] bg-[var(--an-background)] text-[var(--an-foreground)] shadow-[0_20px_60px_color-mix(in_srgb,var(--nim-text)_18%,transparent)] nim-animate-slide-up"
      ...
      >
        <div
          className="worktree-onboarding-header agent-elements-worktree-onboarding-header flex items-start gap-3 border-b border-[var(--an-border-color)] p-[var(--an-spacing-xl)]"
        ...
        <div className="worktree-onboarding-content p-[var(--an-spacing-xl)]">
        ...
        <div
          className="worktree-onboarding-footer agent-elements-worktree-onboarding-actions flex justify-end gap-2 border-t border-[var(--an-border-color)] bg-[var(--an-background-secondary)] p-[var(--an-spacing-xl)]"
