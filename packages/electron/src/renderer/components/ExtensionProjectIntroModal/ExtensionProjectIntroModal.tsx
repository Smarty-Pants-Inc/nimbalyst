...
export const ExtensionProjectIntroModal: React.FC<ExtensionProjectIntroModalProps> = ({
  ...
  const primaryButton =
    'extension-project-intro-primary-button inline-flex min-h-9 cursor-pointer items-center justify-center gap-2 rounded-[var(--an-input-border-radius)] border border-[var(--an-primary-color)] bg-[var(--an-primary-color)] px-5 py-2 text-sm font-medium text-[var(--an-background)] transition-[background-color,border-color,color] duration-150 ease-out hover:border-[var(--nim-primary-hover)] hover:bg-[var(--nim-primary-hover)] focus:outline-none focus:ring-2 focus:ring-[var(--an-input-focus-outline)]';

  return (
    <div
      className="extension-project-intro-overlay nim-overlay agent-elements-extension-project-intro-backdrop fixed inset-0 z-[10000] flex items-center justify-center bg-[color-mix(in_srgb,var(--nim-text)_36%,transparent)] p-4 nim-animate-fade-in"
      onClick={onCancel}
      data-testid="agent-elements-extension-project-intro-backdrop"
      data-agent-elements-shell="extension-project-intro-backdrop"
    >
      <div
        className="extension-project-intro-dialog agent-elements-extension-project-intro agent-elements-tool-card flex w-[min(92vw,480px)] flex-col overflow-hidden rounded-[var(--an-border-radius)] border border-[var(--an-border-color)] bg-[var(--an-background)] text-[var(--an-foreground)] shadow-[0_20px_60px_color-mix(in_srgb,var(--nim-text)_18%,transparent)] nim-animate-slide-up"
      ...
      >
        <div
          className="extension-project-intro-header agent-elements-extension-project-intro-header flex items-start gap-3 border-b border-[var(--an-border-color)] p-[var(--an-spacing-xl)]"
        ...
        <div
          className="extension-project-intro-capabilities agent-elements-extension-project-intro-capabilities flex flex-col gap-[var(--an-spacing-md)] p-[var(--an-spacing-xl)]"
        ...
        <div
          className="extension-project-intro-callout agent-elements-extension-project-intro-callout mx-[var(--an-spacing-xl)] mb-[var(--an-spacing-xl)] rounded-[var(--an-tool-border-radius)] border border-[var(--an-border-color)] bg-[var(--an-background-secondary)] px-[var(--an-spacing-lg)] py-[var(--an-spacing-md)]"
        ...
        <div
          className="extension-project-intro-actions agent-elements-extension-project-intro-actions flex flex-wrap items-center justify-end gap-2 border-t border-[var(--an-border-color)] bg-[var(--an-background-secondary)] p-[var(--an-spacing-xl)]"
