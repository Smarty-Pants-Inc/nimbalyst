 ...
 *
 * Shows session, weekly, and Opus usage with progress bars and reset times.
 */
...
const UsageSection: React.FC<UsageSectionProps> = ({
  ...
  return (
    <div
      ...
      data-testid="agent-elements-claude-usage-section"
    >
  ...
  return (
    <FloatingPortal>
      <div
        ...
        data-agent-elements-shell="claude-usage-popover"
      ...
      >
        <div className="agent-elements-usage-popover-header flex items-center justify-between border-b border-[var(--an-border-color)] px-[var(--agent-elements-card-inline-padding)] py-[var(--agent-elements-card-block-padding)]">
          <div className="flex items-center gap-2">
            <span className="flex h-7 w-7 items-center justify-center rounded-[var(--an-tool-border-radius)] border border-[color-mix(in_srgb,var(--an-warning-color)_28%,var(--an-border-color))] bg-[color-mix(in_srgb,var(--an-warning-color)_10%,var(--an-background))] text-[var(--an-warning-color)]">
              <MaterialSymbol icon="data_usage" size={16} />
            </span>
            <span className="text-[14px] font-semibold leading-5 text-[var(--an-foreground)]">Claude Usage</span>
          </div>
        ...
        <div className="flex flex-col gap-1.5 border-t border-[var(--an-border-color)] px-[var(--agent-elements-card-inline-padding)] py-[var(--an-spacing-sm)]">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              aria-label="Disable Claude usage indicator"
            >
              Disable
            </button>
          </div>
          <button
            ...
            aria-label="Anthropic status page"
          >
