 ...
 * still default to the Smarty Pants dev collab worker so a dev build that
 * hasn't explicitly opted in does not accidentally talk to Nimbalyst-owned
 * infrastructure.
 *
 ...
 * and unconditionally returned localhost in dev. Every shared
...
const PRODUCTION_WS_URL = 'wss://sync-dev.smartypants.ai';
const DEVELOPMENT_WS_URL = 'ws://localhost:8787';
